...
describe('Tunnel', () => {
  ...
  describe('getStats', () => {
    it('should return tunnel statistics', () => {
      ...
      expect(stats).to.have.property('observability')
      expect(stats.observability).to.have.property('reconnect')
      expect(stats.observability).to.have.property('requestHealth')
      expect(stats.observability).to.have.property('backlog')
      expect(stats.observability).to.have.property('streamSignals')
      expect(stats.observability).to.have.property('memory')
      expect(stats.observability.requestHealth).to.have.property('errorRatio')
      expect(stats.observability.requestHealth).to.have.property('timeoutRatio')
      expect(stats.observability.requestHealth.errorRatio).to.equal(0)
      expect(stats.observability.requestHealth.timeoutRatio).to.equal(0)
      expect(stats.observability.backlog).to.have.property('pendingProxyRequests', 0)
      expect(stats.observability.backlog).to.have.property('activeSseRequests', 0)
